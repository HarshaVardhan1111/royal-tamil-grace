...
const FooterSection = () => {
  ...
  const whatsappMsg = encodeURIComponent(
    `💐 You're invited to the wedding of Harshaavardhan & Priyadharshini!\n📅 May 29, 2026 | 📍 Vijaya Mahal, Chinnalapatti\n\n${shareUrl}`
  );
    ...
    <footer className="py-16 px-4 bg-maroon relative overflow-hidden">
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 mt-8 px-6 py-3 rounded-full bg-[#25D366] text-white font-body font-semibold shadow-lg hover:bg-[#1ebe57] hover:scale-105 transition-all duration-300"
        >
