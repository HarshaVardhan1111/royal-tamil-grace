const events = [
  { name: "Haldi", date: "May 26", emoji: "🌼", desc: "Turmeric blessings" },
  { name: "Mehendi", date: "May 27", emoji: "🌿", desc: "Henna celebrations" },
  { name: "Engagement", date: "May 28", emoji: "💍", desc: "Ring ceremony" },
  { name: "Wedding", date: "May 29", emoji: "🪔", desc: "Sacred union" },
];
