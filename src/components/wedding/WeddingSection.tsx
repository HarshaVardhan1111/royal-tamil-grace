  ...
  return (
    <section className="py-20 px-4 relative overflow-hidden bg-ivory-dark">
      ...
      <div className="max-w-lg mx-auto text-center relative z-10">
        ...
        {/* Wedding image */}
        <div className="max-w-md mx-auto mb-8 rounded-2xl overflow-hidden border-4 border-gold gold-glow">
          <img src={weddingImg} alt="Wedding Ceremony" className="w-full h-56 md:h-72 object-cover" />
        </div>
        ...
        <div className="relative max-w-md mx-auto">
          ...
          <div className="p-8 md:p-10 rounded-2xl border-4 border-gold gold-glow bg-ivory relative">
            ...
            <p className="font-heading text-2xl md:text-3xl text-maroon font-bold mt-2 tracking-wider">Vijaya Mahal</p>
