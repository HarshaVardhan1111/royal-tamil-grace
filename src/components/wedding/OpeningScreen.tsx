...
const OpeningScreen = ({ onOpen }: { onOpen: () => void }) => {
  const [stage, setStage] = useState(0); // 0=hidden, 1=title, 2=names, 3=sub, 4=button
  ...
  return (
    <div
      className={`fixed inset-0 z-[100] flex items-center justify-center transition-all duration-[900ms] ease-in-out ${
    ...
    >
      ...
      <div className="absolute inset-3 md:inset-8 pointer-events-none rounded-lg border border-gold-light/40">
        ...
        {["top-0 left-0", "top-0 right-0 rotate-90", "bottom-0 right-0 rotate-180", "bottom-0 left-0 -rotate-90"].map(
          (pos, i) => (
            ...
            >
              <path
                d="M5 5 Q5 30 15 40 Q5 35 5 50 M5 5 Q30 5 40 15 Q35 5 50 5"
                stroke="hsl(43, 60%, 55%)"
                fill="none"
                strokeWidth="1.5"
              />
              <path
                d="M8 8 Q15 20 20 25 M8 8 Q20 15 25 20"
                stroke="hsl(43, 60%, 55%)"
                fill="none"
                strokeWidth="1"
              />
      ...
      <div className="relative z-10 text-center px-6">
        ...
        {/* Decorative line */}
        <div
          className={`mx-auto my-5 md:my-6 transition-all duration-1000 ease-out delay-200 ${
        ...
        >
          Harshavardhan
          <span className="block text-3xl sm:text-4xl md:text-5xl my-1 md:my-2" style={{
            WebkitTextFillColor: "hsl(345 55% 35%)",
          }}>
            ❤️
          </span>
          Priyadharshini
        ...
        {/* Decorative line */}
        <div
          className={`mx-auto my-5 md:my-6 transition-all duration-1000 ease-out ${
        ...
        <button
          onClick={handleOpen}
          className={`mt-4 md:mt-6 px-8 py-3 md:px-10 md:py-3.5 rounded-full font-display text-sm md:text-base uppercase tracking-[0.2em] transition-all duration-700 ease-out cursor-pointer
